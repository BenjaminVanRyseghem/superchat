...
goog.iter.dropWhile = function(a, b, c) {
  a = goog.iter.toIterator(a);
  var d = new goog.iter.Iterator, e = !0;
  d.next = function() {
    for (;;) {
      var d = a.next();
...
goog.events.listen = function(a, b, c, d, e) {
  if (b) {
    ...
    var g = g[d], h = goog.getUid(a), k;
    g.remaining_++;
    if (g[h]) {
      for (k = g[h], f = 0;f < k.length;f++) {
        if (g = k[f], g.listener == c && g.handler == e) {
          if (g.removed) {
            break;
          }
          return k[f].key;
  ...
  if (null == a) {
    goog.object.forEach(goog.events.sources_, function(a) {
      for (var g = a.length - 1;0 <= g;g--) {
        var h = a[g];
        !e && b != h.type || !f && c != h.capture || (goog.events.unlistenByKey(h.key), d++);
      }
    });
  } else {
...
goog.events.handleBrowserEvent_ = function(a, b) {
  ...
  if (!goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
    ...
    try {
      if (h) {
        for (var m = [], n = l.currentTarget;n;n = n.parentNode) {
          m.push(n);
        }
        g = e[!0];
        g.remaining_ = g.count_;
        for (var p = m.length - 1;!l.propagationStopped_ && 0 <= p && g.remaining_;p--) {
          l.currentTarget = m[p], f &= goog.events.fireListeners_(g, m[p], d, !0, l);
        }
        if (k) {
          for (g = e[!1], g.remaining_ = g.count_, p = 0;!l.propagationStopped_ && p < m.length && g.remaining_;p++) {
            l.currentTarget = m[p], f &= goog.events.fireListeners_(g, m[p], d, !1, l);
          }
        }
      } else {
        f = goog.events.fireListener(c, l);
      }
    } finally {
      m && (m.length = 0), l.dispose();
    }
    return f;
  }
...
cljs.core._invoke = function() {
  var a = null, b = function(a) {
  ...
  }, C = function(a, b, c, d, e, f, g, h, k, l, m, q, n, r, p, s, t, u, H, v) {
    ...
    return C.call(null, a, b, c, d, e, f, g, h, k, l, m, q, n, r, p, s, t, u, H, v, w);
  }, H = function(a, b, c, d, e, f, g, h, k, l, m, q, n, r, p, s, t, u, H, v, w, C) {
    if (a ? a.cljs$core$IFn$_invoke$arity$22 : a) {
      return a.cljs$core$IFn$_invoke$arity$22(a, b, c, d, e, f, g, h, k, l, m, q, n, r, p, s, t, u, H, v, w, C);
    }
    var J;
    ...
    return J.call(null, a, b, c, d, e, f, g, h, k, l, m, q, n, r, p, s, t, u, H, v, w, C);
...
cljs.core.MetaFn.prototype.call = function() {
  var a = null, b = function(a) {
    ...
    return cljs.core.apply.call(null, this.afn, b, c, d, e, f, g, h, k, l, m, q, n, r, p, s, t, u, H, v, w, C);
  }, a = function(a, x, y, z, A, B, D, E, F, G, I, K, L, M, N, O, Q, R, S, T, V, U) {
    switch(arguments.length) {
      case 1:
        return b.call(this, a);
...
cljs.core.nil_iter = function nil_iter() {
  "undefined" === typeof cljs.core.t5606 && (cljs.core.t5606 = function(b, c) {
    this.nil_iter = b;
    this.meta5607 = c;
    this.cljs$lang$protocol_mask$partition1$ = 0;
    this.cljs$lang$protocol_mask$partition0$ = 393216;
  }, cljs.core.t5606.cljs$lang$type = !0, cljs.core.t5606.cljs$lang$ctorStr = "cljs.core/t5606", cljs.core.t5606.cljs$lang$ctorPrWriter = function(b, c, d) {
    return cljs.core._write.call(null, c, "cljs.core/t5606");
  }, cljs.core.t5606.prototype.hasNext = function() {
    return!1;
  }, cljs.core.t5606.prototype.next = function() {
    return Error("No such element");
  }, cljs.core.t5606.prototype.remove = function() {
    return Error("Unsupported operation");
  }, cljs.core.t5606.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
    return this.meta5607;
  }, cljs.core.t5606.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
    return new cljs.core.t5606(this.nil_iter, c);
  }, cljs.core.__GT_t5606 = function(b, c) {
    return new cljs.core.t5606(b, c);
  });
  return new cljs.core.t5606(nil_iter, null);
};
...
var bc = {dom_helpers:{}};
bc.dom_helpers.get_element = function(a) {
  return goog.dom.getElement(cljs.core.name.call(null, a));
};
bc.dom_helpers.show_element = function(a, b) {
  return goog.style.showElement(a, b);
};
bc.dom_helpers.add_remove_class = function(a, b, c) {
  return goog.dom.classes.addRemove(a, c, b);
};
bc.dom_helpers.get_radio_value = function(a, b) {
  return goog.dom.forms.getValueByName(bc.dom_helpers.get_element.call(null, a), b);
};
bc.dom_helpers.value = function(a) {
  return goog.dom.forms.getValue(a);
};
bc.dom_helpers.set_value = function(a) {
  return goog.dom.forms.setValue(a);
};
bc.dom_helpers.set_disabled = function(a, b) {
  return goog.dom.forms.setDisabled(a, b);
};
bc.dom_helpers.append = function() {
  var a = function(a, b) {
    for (var e = cljs.core.seq.call(null, b), f = null, g = 0, h = 0;;) {
      if (h < g) {
        var k = cljs.core._nth.call(null, f, h);
        goog.dom.appendChild(a, k);
        h += 1;
      } else {
        if (e = cljs.core.seq.call(null, e)) {
          f = e, cljs.core.chunked_seq_QMARK_.call(null, f) ? (e = cljs.core.chunk_first.call(null, f), h = cljs.core.chunk_rest.call(null, f), f = e, g = cljs.core.count.call(null, e), e = h) : (e = cljs.core.first.call(null, f), goog.dom.appendChild(a, e), e = cljs.core.next.call(null, f), f = null, g = 0), h = 0;
        } else {
          break;
        }
      }
...
bc.dom_helpers.set_text = function(a, b) {
  var c = a instanceof cljs.core.Keyword || "string" === typeof a ? bc.dom_helpers.get_element.call(null, a) : a;
  goog.dom.setTextContent(c, b);
  return c;
};
bc.dom_helpers.normalize_args = function(a, b) {
  var c = clojure.string.split.call(null, a, /(\.|#)/), d = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null, c), cljs.core.apply.call(null, cljs.core.hash_map, cljs.core.map.call(null, function(a) {
    return function(a) {
      return cljs.core._EQ_.call(null, a, ".") ? new cljs.core.Keyword(null, "class", "class", -2030961996) : cljs.core._EQ_.call(null, a, "#") ? new cljs.core.Keyword(null, "id", "id", -1388402092) : a;
    };
  }(c), cljs.core.rest.call(null, c)))], null), c = cljs.core.nth.call(null, d, 0, null), d = cljs.core.nth.call(null, d, 1, null);
  return cljs.core.map_QMARK_.call(null, cljs.core.first.call(null, b)) ? new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [c, cljs.core.merge.call(null, d, cljs.core.first.call(null, b)), cljs.core.rest.call(null, b)], null) : new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [c, d, b], null);
};
bc.dom_helpers.element = function() {
  var a = function(a, d) {
    var e = bc.dom_helpers.normalize_args.call(null, a, d), f = cljs.core.nth.call(null, e, 0, null), g = cljs.core.nth.call(null, e, 1, null), h = cljs.core.nth.call(null, e, 2, null), e = goog.dom.createDom(cljs.core.subs.call(null, f, 1), cljs.core.reduce.call(null, function(a, b, c, d) {
      return function(a, b) {
        var c = cljs.core.nth.call(null, b, 0, null), d = cljs.core.nth.call(null, b, 1, null);
        return cljs.core.assoc.call(null, a, c, d);
      };
    }(e, f, g, h), cljs.core.PersistentArrayMap.EMPTY, cljs.core.map.call(null, function(a, b, c, d) {
      return function(a, b) {
        return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.name.call(null, a), b], null);
      };
    }(e, f, g, h), cljs.core.keys.call(null, g), cljs.core.vals.call(null, g))).strobj), g = "string" === typeof cljs.core.first.call(null, h) ? new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bc.dom_helpers.set_text.call(null, b.call(null, f, g), cljs.core.first.call(null, h)), cljs.core.rest.call(null, h)], null) : new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [e, h], null), f = cljs.core.nth.call(null, g, 0, null), g = cljs.core.nth.call(null, 
    g, 1, null);
    return cljs.core.apply.call(null, bc.dom_helpers.append, f, g);
  }, b = function(b, d) {
    var e = null;
    1 < arguments.length && (e = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0));
    return a.call(this, b, e);
...
bc.dom_helpers.remove_children = function(a) {
  return goog.dom.removeChildren(a);
};
bc.dom_helpers.html = function(a) {
  return goog.dom.htmlToDocumentFragment(a);
};
bc.dom_helpers.element_arg_QMARK_ = function(a) {
  return a instanceof cljs.core.Keyword || cljs.core.map_QMARK_.call(null, a) || "string" === typeof a;
};
bc.dom_helpers.build = function build(b) {
  if (cljs.core.vector_QMARK_.call(null, b)) {
    var c = cljs.core.first.call(null, b) instanceof cljs.core.Keyword ? new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.apply.call(null, bc.dom_helpers.element, cljs.core.take_while.call(null, bc.dom_helpers.element_arg_QMARK_, b)), cljs.core.drop_while.call(null, bc.dom_helpers.element_arg_QMARK_, b)], null) : new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null, b), cljs.core.rest.call(null, b)], 
    null);
    b = cljs.core.nth.call(null, c, 0, null);
    c = cljs.core.nth.call(null, c, 1, null);
    c = cljs.core.map.call(null, build, c);
    return cljs.core.apply.call(null, bc.dom_helpers.append, b, c);
  }
  return b;
};
bc.dom_helpers.insert_at = function(a, b, c) {
  return goog.dom.insertChildAt(a, b, c);
};
bc.dom_helpers.set_timeout = function(a, b) {
  return goog.Timer.callOnce(a, b);
};
bc.dom_helpers.set_position = function(a, b, c) {
  return goog.style.setPosition(a, b, c);
};
bc.dom_helpers.get_position = function(a) {
  return goog.style.getPosition(a);
};
bc.dom_helpers.toggle_class = function(a, b) {
  return goog.dom.classes.toggle(a, b);
};
bc.dom_helpers.add_class = function(a, b) {
  return goog.dom.classes.add(a, b);
};
bc.dom_helpers.remove_class = function(a, b) {
  return goog.dom.classes.remove(a, b);
};
goog.uri = {};
goog.uri.utils = {};
...
goog.uri.utils.appendKeyValuePairs_ = function(a, b, c) {
  if (goog.isArray(b)) {
    for (var d = 0;d < b.length;d++) {
      c.push("\x26", a), "" !== b[d] && c.push("\x3d", goog.string.urlEncode(b[d]));
    }
  } else {
    null != b && (c.push("\x26", a), "" !== b && c.push("\x3d", goog.string.urlEncode(b)));
  }
};
...
goog.Uri.QueryData.prototype.getValues = function(a) {
  ...
  var b = [];
  if (a) {
    a = this.getKeyName_(a), this.containsKey(a) && (b = goog.array.concat(b, this.keyMap_.get(a)));
  } else {
  ...
  for (var a = [], b = 0, c = this.keyMap_.getKeys(), d = 0;d < c.length;d++) {
    ...
    if (goog.isArray(e)) {
      for (var g = 0;g < e.length;g++) {
        0 < b && a.push("\x26"), a.push(f), "" !== e[g] && a.push("\x3d", goog.string.urlEncode(e[g])), b++;
      }
    } else {
      0 < b && a.push("\x26"), a.push(f), "" !== e && a.push("\x3d", goog.string.urlEncode(e)), b++;
    }
  }
...
goog.debug.HtmlFormatter.prototype.formatRecord = function(a) {
  ...
  c.push('\x3cspan class\x3d"', b, '"\x3e', goog.string.newLineToBr(goog.string.whitespaceEscape(goog.string.htmlEscape(a.getMessage()))));
  this.showExceptionText && a.getException() && c.push("\x3cbr\x3e", goog.string.newLineToBr(goog.string.whitespaceEscape(a.getExceptionText() || "")));
  c.push("\x3c/span\x3e\x3cbr\x3e");
  return c.join("");
};
...
goog.events.OnlineHandler = function() {
  ...
  goog.events.BrowserFeature.HAS_NAVIGATOR_ONLINE_PROPERTY && (goog.events.BrowserFeature.HAS_HTML5_NETWORK_EVENT_SUPPORT ? this.eventHandler_.listen(goog.events.BrowserFeature.HTML5_NETWORK_EVENTS_FIRE_ON_BODY ? document.body : window, ["online", "offline"], this.handleChange_) : (this.online_ = this.isOnline(), this.timer_ = new goog.Timer(goog.events.OnlineHandler.POLL_INTERVAL_), this.eventHandler_.listen(this.timer_, goog.Timer.TICK, this.handleTick_), this.timer_.start()));
};
goog.inherits(goog.events.OnlineHandler, goog.events.EventTarget);
goog.events.OnlineHandler.EventType = {ONLINE:"online", OFFLINE:"offline"};
goog.events.OnlineHandler.POLL_INTERVAL_ = 250;
goog.events.OnlineHandler.prototype.isOnline = function() {
  return goog.events.BrowserFeature.HAS_NAVIGATOR_ONLINE_PROPERTY ? navigator.onLine : !0;
};
goog.events.OnlineHandler.prototype.handleTick_ = function(a) {
  var b = this.isOnline();
  b != this.online_ && (this.online_ = b, this.handleChange_(a));
};
goog.events.OnlineHandler.prototype.handleChange_ = function(a) {
  a = this.isOnline() ? goog.events.OnlineHandler.EventType.ONLINE : goog.events.OnlineHandler.EventType.OFFLINE;
  this.dispatchEvent(a);
};
goog.events.OnlineHandler.prototype.disposeInternal = function() {
  ...
  this.timer_ && (this.timer_.dispose(), delete this.timer_);
};
goog.net = {};
...
goog.net.ChannelRequest = function(a, b, c, d, e, f) {
  this.channel_ = a;
...
goog.net.ChannelRequest.Error = {STATUS:0, NO_DATA:1, TIMEOUT:2, UNKNOWN_SESSION_ID:3, BAD_DATA:4, HANDLER_EXCEPTION:5, BROWSER_OFFLINE:6};
...
goog.net.ChannelRequest.prototype.sendXmlHttp_ = function(a) {
  ...
  if (this.checkOnlineHandler_()) {
    ...
    this.eventHandler_.listen(this.xmlHttp_, goog.net.EventType.READY_STATE_CHANGE, this.xmlHttpHandler_, !1, this);
...
goog.net.ChannelRequest.prototype.onXmlHttpReadyStateChanged_ = function() {
  ...
  if (!goog.net.ChannelRequest.supportsXhrStreaming() || goog.userAgent.WEBKIT && !goog.userAgent.isVersion(goog.net.ChannelRequest.MIN_WEBKIT_FOR_INTERACTIVE_)) {
  ...
  var b = this.xmlHttp_.getStatus();
  this.lastStatusCode_ = b;
  var c = this.xmlHttp_.getResponseText();
  c || this.channelDebug_.debug("No response text for uri " + this.requestUri_ + " status " + b);
  ...
  if (this.successful_) {
    if (a == goog.net.XmlHttp.ReadyState.COMPLETE && this.cleanup_(), this.decodeChunks_ ? (this.decodeNextChunks_(a, c), goog.userAgent.OPERA && a == goog.net.XmlHttp.ReadyState.INTERACTIVE && this.startPolling_()) : (this.channelDebug_.xmlHttpChannelResponseText(this.rid_, c, null), this.safeOnRequestData_(c)), this.successful_ && !this.cancelled_) {
      if (a == goog.net.XmlHttp.ReadyState.COMPLETE) {
    ...
    400 == b && 0 < c.indexOf("Unknown SID") ? (this.lastError_ = goog.net.ChannelRequest.Error.UNKNOWN_SESSION_ID, goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.REQUEST_UNKNOWN_SESSION_ID)) : (this.lastError_ = goog.net.ChannelRequest.Error.STATUS, goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.REQUEST_BAD_STATUS)), this.channelDebug_.xmlHttpChannelResponseText(this.rid_, c), this.cleanup_(), this.dispatchFailure_();
  }
};
...
goog.net.ChannelRequest.prototype.checkOnlineHandler_ = function() {
  ...
  if (this.onlineHandler_.isOnline()) {
    return this.eventHandler_.listen(this.onlineHandler_, goog.events.OnlineHandler.EventType.OFFLINE, this.cancelRequestAsBrowserIsOffline_), !0;
  }
...
goog.net.ChannelRequest.prototype.tridentGet_ = function(a) {
  ...
  if (this.checkOnlineHandler_()) {
    ...
    var c = "\x3chtml\x3e\x3cbody\x3e";
    a && (c += '\x3cscript\x3edocument.domain\x3d"' + b + '"\x3c/script\x3e');
    c += "\x3c/body\x3e\x3c/html\x3e";
    this.trident_.open();
    this.trident_.write(c);
    this.trident_.close();
    ...
    a.innerHTML = '\x3ciframe src\x3d"' + this.requestUri_ + '"\x3e\x3c/iframe\x3e';
...
goog.net.ChannelRequest.prototype.onTridentDoneAsync_ = function(a) {
  this.cancelled_ || (this.channelDebug_.tridentChannelResponseDone(this.rid_, a), this.cleanup_(), this.successful_ = a, this.channel_.onRequestComplete(this));
};
...
goog.net.ChannelDebug.prototype.redactResponse_ = function(a) {
  ...
  try {
    for (var b = goog.json.unsafeParse(a), c = 0;c < b.length;c++) {
...
goog.net.ChannelDebug.prototype.maybeRedactPostData_ = function(a) {
  ...
  for (var c = 0;c < a.length;c++) {
    var d = a[c].split("\x3d");
    if (1 < d.length) {
      var e = d[0], d = d[1], f = e.split("_"), b = 2 <= f.length && "type" == f[1] ? b + (e + "\x3d" + d + "\x26") : b + (e + "\x3dredacted\x26")
    }
  }
  return b;
};
...
goog.net.tmpnetwork.testLoadImage = function(a, b, c) {
  ...
  e.onload = function() {
    try {
      d.debug("TestLoadImage: loaded"), goog.net.tmpnetwork.clearImageCallbacks_(e), c(!0);
    } catch (a) {
      d.dumpException(a);
    }
  };
  e.onerror = function() {
    try {
      d.debug("TestLoadImage: error"), goog.net.tmpnetwork.clearImageCallbacks_(e), c(!1);
    } catch (a) {
      d.dumpException(a);
    }
  };
  e.onabort = function() {
    try {
      d.debug("TestLoadImage: abort"), goog.net.tmpnetwork.clearImageCallbacks_(e), c(!1);
    } catch (a) {
      d.dumpException(a);
    }
  };
  e.ontimeout = function() {
    try {
      d.debug("TestLoadImage: timeout"), goog.net.tmpnetwork.clearImageCallbacks_(e), c(!1);
    } catch (a) {
      d.dumpException(a);
    }
  };
...
goog.net.BrowserTestChannel.prototype.connect = function(a) {
  ...
  this.request_ = goog.net.BrowserChannel.createChannelRequest(this, this.channelDebug_, void 0, void 0, void 0, this.channel_.getOnlineHandler());
  this.request_.setExtraHeaders(this.extraHeaders_);
  this.request_.xmlHttpGet(a, !1, null, !0);
...
goog.net.BrowserTestChannel.prototype.connectStage2_ = function() {
  ...
  goog.net.ChannelRequest.supportsXhrStreaming() ? (a.setParameterValues("TYPE", "xmlhttp"), this.request_.xmlHttpGet(a, !1, this.hostPrefix_, !1)) : (a.setParameterValues("TYPE", "html"), this.request_.tridentGet(a, Boolean(this.hostPrefix_)));
};
...
goog.net.BrowserChannel = function(a) {
...
goog.net.BrowserChannel.RETRY_DELAY_MS = 5E3;
goog.net.BrowserChannel.RETRY_DELAY_SEED = 1E4;
...
goog.net.BrowserChannel.createChannelRequest = function(a, b, c, d, e, f) {
  return new goog.net.ChannelRequest(a, b, c, d, e, f);
};
...
goog.net.BrowserChannel.prototype.disconnect = function() {
  ...
  if (this.state_ == goog.net.BrowserChannel.State.OPENED) {
    ...
    goog.net.BrowserChannel.createChannelRequest(this, this.channelDebug_, this.sid_, a, void 0, this.onlineHandler_).sendUsingImgTag(b);
    this.onClose_();
  }
};
...
goog.net.BrowserChannel.prototype.connectTest_ = function(a) {
  ...
  this.okToMakeRequest_() && (this.connectionTest_ = new goog.net.BrowserTestChannel(this, this.channelDebug_), this.connectionTest_.setExtraHeaders(this.extraHeaders_), this.connectionTest_.connect(a));
};
...
goog.net.BrowserChannel.prototype.open_ = function() {
  ...
  var a = this.nextRid_++, b = goog.net.BrowserChannel.createChannelRequest(this, this.channelDebug_, "", a, void 0, this.onlineHandler_);
...
goog.net.BrowserChannel.prototype.makeForwardChannelRequest_ = function(a) {
  ...
  b = goog.net.BrowserChannel.createChannelRequest(this, this.channelDebug_, this.sid_, b, this.forwardChannelRetryCount_ + 1, this.onlineHandler_);
  b.setExtraHeaders(this.extraHeaders_);
  b.setTimeout(Math.round(.5 * goog.net.BrowserChannel.FORWARD_CHANNEL_RETRY_TIMEOUT) + Math.round(.5 * goog.net.BrowserChannel.FORWARD_CHANNEL_RETRY_TIMEOUT * Math.random()));
  this.forwardChannelRequest_ = b;
  b.xmlHttpPost(c, a, !0);
};
...
goog.net.BrowserChannel.prototype.dequeueOutgoingMaps_ = function() {
  var a = Math.min(this.outgoingMaps_.length, goog.net.BrowserChannel.MAX_MAPS_PER_REQUEST_), b = ["count\x3d" + a], c;
  6 < this.channelVersion_ && 0 < a ? (c = this.outgoingMaps_[0].mapId, b.push("ofs\x3d" + c)) : c = 0;
  for (var d = 0;d < a;d++) {
    ...
    try {
      goog.structs.forEach(f, function(a, c, d) {
        b.push("req" + e + "_" + c + "\x3d" + encodeURIComponent(a));
      });
    } catch (g) {
      b.push("req" + e + "_type\x3d" + encodeURIComponent("_badmap")), this.handler_ && this.handler_.badMapError(this, f);
    }
  }
...
goog.net.BrowserChannel.prototype.isBrowserOnline_ = function() {
  return this.onlineHandler_ ? this.onlineHandler_.isOnline() : !0;
};
goog.net.BrowserChannel.prototype.maybeRetryBackChannel_ = function() {
  if (this.backChannelRequest_ || this.backChannelTimerId_) {
    return this.channelDebug_.severe("Request already in progress"), !1;
  }
  if (this.backChannelRetryCount_ >= this.getBackChannelMaxRetries() || !this.isBrowserOnline_()) {
    return!1;
  }
...
goog.net.BrowserChannel.prototype.startBackChannel_ = function() {
  if (this.okToMakeRequest_()) {
    ...
    this.backChannelRequest_ = goog.net.BrowserChannel.createChannelRequest(this, this.channelDebug_, this.sid_, "rpc", this.backChannelAttemptId_, this.onlineHandler_);
...
goog.net.BrowserChannel.prototype.setOnlineHandler = function(a) {
  this.onlineHandler_ = a;
};
...
goog.net.BrowserChannel.prototype.onRequestData = function(a, b) {
  if (this.state_ != goog.net.BrowserChannel.State.CLOSED && (this.backChannelRequest_ == a || this.forwardChannelRequest_ == a)) {
    if (this.lastStatusCode_ = a.getLastStatusCode(), this.forwardChannelRequest_ == a && this.state_ == goog.net.BrowserChannel.State.OPENED) {
      ...
      if (this.backChannelRequest_ == a && this.clearDeadBackchannelTimer_(), !goog.string.isEmpty(b)) {
        this.onInput_(goog.json.unsafeParse(b));
      }
    }
  }
};
...
goog.net.BrowserChannel.isFatalError_ = function(a, b) {
  return a == goog.net.ChannelRequest.Error.UNKNOWN_SESSION_ID || a == goog.net.ChannelRequest.Error.STATUS && 0 < b;
};
...
goog.net.BrowserChannel.prototype.getRetryTime_ = function(a) {
  var b = goog.net.BrowserChannel.RETRY_DELAY_MS + Math.floor(Math.random() * goog.net.BrowserChannel.RETRY_DELAY_SEED);
...
goog.net.BrowserChannel.prototype.onInput_ = function(a) {
  for (var b = this.handler_ && this.handler_.channelHandleMultipleArrays ? [] : null, c = 0;c < a.length;c++) {
    ...
    this.state_ == goog.net.BrowserChannel.State.OPENED && ("stop" == d[0] ? (b && b.length && (this.handler_.channelHandleMultipleArrays(this, b), b.length = 0), this.signalError_(goog.net.BrowserChannel.Error.STOP)) : "noop" != d[0] && (b ? b.push(d) : this.handler_ && this.handler_.channelHandleArray(this, d)), this.backChannelRetryCount_ = 0);
  }
...
goog.net.BrowserChannel.LogSaver.setEnabled = function(a) {
  if (a != goog.net.BrowserChannel.LogSaver.enabled_) {
    var b = goog.net.BrowserChannel.LogSaver.addLogRecord, c = goog.debug.Logger.getLogger("goog.net");
    a ? c.addHandler(b) : c.removeHandler(b);
  }
};
...
goog.events.KeyHandler.prototype.handleKeyDown_ = function(a) {
  goog.userAgent.WEBKIT && (this.lastKey_ == goog.events.KeyCodes.CTRL && !a.ctrlKey || this.lastKey_ == goog.events.KeyCodes.ALT && !a.altKey) && (this.keyCode_ = this.lastKey_ = -1);
...
var superchat = {client:{}};
superchat.client.channel = new goog.net.BrowserChannel;
superchat.client.say = function(a) {
  return superchat.client.channel.sendMap(function() {
    var b;
    b = {};
    b.msg = a;
    return b;
...
superchat.client.enable_chat = function() {
  var a = bc.dom_helpers.get_element.call(null, "msg-input"), b = bc.dom_helpers.get_element.call(null, "send-button"), c = function(a, b) {
    return function(b) {
      superchat.client.say.call(null, bc.dom_helpers.value.call(null, a));
      return bc.dom_helpers.set_value.call(null, a, "");
    };
  }(a, b);
  bc.dom_helpers.set_disabled.call(null, a, !1);
  bc.dom_helpers.set_disabled.call(null, b, !1);
  goog.events.listen(new goog.events.KeyHandler(a), "key", function(a, b, c) {
    return function(a) {
      return cljs.core._EQ_.call(null, a.keyCode, goog.events.KeyCodes.ENTER) ? c.call(null, a) : null;
    };
  }(a, b, c));
  return goog.events.listen(b, "click", c);
};
superchat.client.handler = function() {
  var a = new goog.net.BrowserChannel.Handler;
  a.channelOpened = function(a) {
    return function(a) {
      return superchat.client.enable_chat.call(null);
    };
  }(a);
  a.channelHandleArray = function(a) {
    return function(a, b) {
      var e = b.msg;
      return bc.dom_helpers.append.call(null, bc.dom_helpers.get_element.call(null, "room"), bc.dom_helpers.element.call(null, new cljs.core.Keyword(null, "div", "div", 1057191632), "MSG::" + cljs.core.str.cljs$core$IFn$_invoke$arity$1(e)));
    };
  }(a);
  return a;
};
superchat.client.run = function() {
  goog.events.listen(window, "unload", function() {
    superchat.client.channel.disconnect(cljs.core.List.EMPTY);
    return goog.events.removeAll();
  });
  superchat.client.channel.getChannelDebug().getLogger().setLevel(goog.debug.Logger.Level.OFF);
  var a = superchat.client.channel;
  a.setHandler(superchat.client.handler.call(null));
  a.connect("/channel/test", "/channel/bind");
  return a;
};
